...
export default function Emergency() {
  return (
    <>
      ...
      />
      <main className={s.emergency}>
        <EmergencyContact />
        <PaymentAssistance />
        <div className={s.text}>
          <h2 className={s.title}>Emergency</h2>
          <p className={s.content}>
            Emergency Veterinarians are an integral part of veterinary medicine.
            Many serious conditions occur without warning and cannot wait for a
            scheduled appointment with your primary care veterinarian.
          </p>
          <p className={s.content}>
            ...
            They are available 24 hours a day, 7 days a week, including weekends
            and holidays, to ensure that you get the care and attention you
