export const emergencyCommunicationText: string[] = [
  "You will have access to the Emergency team for follow-up questions or concerns via phone, or e- mail, or in-person 24-7.",
