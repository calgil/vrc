...
export const emergencyReasons: ServiceDetail[] = [
  ...
  },
  {
    title: "Collapsing",
    content:
      "Collapsing can be a symptom of many serious illnesses. Major causes are bleeding, severe organ dysfunction, blood cell disorders, changes in blood pressure, intoxication, electrolyte imbalances, severe dehydration, and heart disease.",
  },
  {
    title: "Changes in gum color",
    content:
  ...
  {
    title: "Difficulty Breathing or Severe Coughing",
    content:
  ...
  {
    title: "Weakness, Lethargy, Unconsciousness",
    content:
  ...
  {
    title: "Inability to pass urine or feces",
    content:
  ...
  {
    title: "Complications with known disease states",
    content:
