...
export const surgeryServices: ServiceDetail[] = [
  {
  ...
  {
    title: "Complicated Wound Care and Skin Grafts",
    content:
  ...
  {
    title: "Total Ear Canal Ablation and Bulla Osteotomy (TECA-BO)",
    content:
  ...
  {
    title: "Patent Ductus Arteriosus Ligation",
    content:
  ...
  {
    title: "Cranial Cruciate Ligament Treatment",
    content:
  ...
  {
    title: "Femoral Head Ostectomy (FHO)",
    content:
